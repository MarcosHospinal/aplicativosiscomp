...
public class Product {
    ...
    public  static ArrayList<Product> getProductsAsString() {
        ...
        o.add(new Product(1,"Teclados"));
        o.add(new Product(2,"Mause"));
        o.add(new Product(3,"Mainboars"));
        o.add(new Product(4,"Impresoras"));
        o.add(new Product(5,"Monitores"));
        o.add(new Product(6,"Laptops"));
        o.add(new Product(7,"Cases"));
        return  o;
    }
